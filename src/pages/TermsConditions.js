...
export default function TermsConditions() {
  ...
  const validateForm = () => {
    ...
    if (!formData.extra.trim()) {
      newErrors.extra = "Please enter extra content";
    }
  ...
  return (
    <div>
      ...
      >
        <div className="space-y-3">
          ...
          <div>
            ...
            <textarea
              placeholder="Extra content here"
              ...
              className={`w-full h-36 rounded-xl bg-[#F5F5F5] p-5 mt-3 outline-none text-[16px] resize-none border ${
                errors.extra ? "border-red-500" : "border-transparent"
              }`}
            />

            {errors.extra && (
              <p className="text-red-500 text-sm mt-0">{errors.extra}</p>
            )}
          </div>
        ...
        {selectedTerm && (
          <div className="px-3 pb-3">
            <div className="mt-8 space-y-8">
              ...
              <p className="text-[#555555] text-[18px] leading-[1.5] whitespace-pre-line">
                {selectedTerm.extra}
              </p>
            </div>
          </div>
      ...
      <SuccessModal
        ...
        title={
          editId ? "Terms Successfully Updated" : "Terms Successfully Added"
        }
      />
    </div>
  );
